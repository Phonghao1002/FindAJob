                            ...
                            <TableBody>
                                {recruitNews.map((recruitNew) => (
                                    <StyledTableRow key={recruitNew.title}>
                                        <StyledTableCell align="right">{recruitNew._id} </StyledTableCell>
                                        ...
                                        <StyledTableCell align="right">{recruitNew.content} </StyledTableCell>
                                        <StyledTableCell align="right">{recruitNew.price}</StyledTableCell>
                                        <StyledTableCell align="right">{recruitNew.address}</StyledTableCell>
                                        <StyledTableCell align="right">{recruitNew.rank}</StyledTableCell>
                                        ...
                                        <StyledTableCell className="cellActionRN">
                                            ...
                                            <Link id="btn_delete" to="#"
                                                onClick={() => deleteRecruitNews(recruitNew._id, recruitNew.images.public_id)}
                                                style={{ textDecoration: "none" }}>

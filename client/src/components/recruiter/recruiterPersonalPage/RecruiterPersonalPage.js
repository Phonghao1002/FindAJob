...
import "./recruiterPersonalPage.scss"

const RecruiterPersonalPage = () => {
                            ...
                            <div className="right">
                                <form>
                                    ...
                                    <div className="formInput">
                                        ...
                                        <input type="file" id="logo" onChange={e => SetLogo(e.target.files[0])} style={{ display: "none" }} />
                                    </div>
                                    <div className="formInput" >
...
export default RecruiterPersonalPage
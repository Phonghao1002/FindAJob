                    ...
                    <>
                        ...
                        <div className="headerSearch">
                            <div className="headerSearchItem">
                                ...
                                <select className="lsOptioncbbox" name='category' value={category} onChange={handleCategory}>
                            ...
                            <div className="headerSearchItem">
                                <div className="headerSearchInput">
                                    <input type="text" value={search} className="headerSearchInput"
                            ...
                            <div className="headerSearchItem">
                                <span>Sort By: </span>
                                <select value={sort} onChange={e => setSort(e.target.value)} className="lsOptioncbbox">

        ...
        <div>
            <div className="searchItem">
                ...
                <div className="siDesc">
                    ...
                    <span className="siCancelOp">$ Lương: {formatPrice(recruitNew.price)} VNĐ</span>
                ...
                <div className="siDetails">
                    <div className="siRating">
                        ...
                        <button onClick={() => addSaveJobs(recruitNew)}><FavoriteBorderIcon /></button>
                    </div>
                    <div className="siDetailTexts">
                        <span className="siPrice">Còn 30 ngày để ứng tuyển</span>
